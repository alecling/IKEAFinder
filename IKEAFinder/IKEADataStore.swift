...
//final means it can never be inherited
final class IKEADataStore {
    
    static let sharedInstance = IKEADataStore() //it lets us create only one single type of data
    
    var allIKEAs = [IKEA]()
    
    init(){
        //paste code of pastebin
        ...
        //adding all of these object into the array
